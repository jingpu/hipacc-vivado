#ifndef _CCGAUSSGAUSSXY_CC_
#define _CCGAUSSGAUSSXY_CC_


struct ccGaussGaussXYKernelKernel {

  ccGaussGaussXYKernelKernel() {
  }
...
void ccGaussGaussXYKernel(hls::stream<float > &Output, hls::stream<float > &Input, int IS_width, int IS_height) {
    struct ccGaussGaussXYKernelKernel kernel;
